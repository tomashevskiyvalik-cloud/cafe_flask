...
- Учасники:
  - **Томашевський Валентин Дмитрович** — лідер, архітектура БД, ORM моделі
  - **Михайло Чижук Михайлович** — розробка маршрутів, CRUD, обробка запитів
  - **Максим Римарук Олександрович** — інтерфейс, шаблони, UI адмін-панелі

## Завдання

### Обрана предметна область

Система керування інтернет-кафе, що дозволяє клієнтам переглядати меню, залишати відгуки, а адміністрації — керувати асортиментом та замовленнями.

### Реалізовані вимоги

- [x] Рівень 1: БД, CRUD, базові маршрути
- [x] Рівень 2: додаткові таблиці та зв’язки
- [x] Рівень 3: покращення UX та адмін-функцій
...
#### Роль у команді — **Чижук М.М.**

- розробка маршрутів Flask
- обробка форм
- API логіка збереження замовлень та відгуків
- методи CRUD
...
Реалізовано роботу серверної частини вебзастосунку. Набуто досвід у роботі з роутингом, SQLAlchemy, контролем станів замовлень та обробкою користувацького вводу.
