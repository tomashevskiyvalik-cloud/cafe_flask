...
- Учасники:
  - **Томашевський Валентин Дмитрович** — лідер команди, проєктування схеми БД, ORM-моделі
  - **Михайло Чижук Михайлович** — розробка маршрутів та CRUD логіки
  - **Максим Римарук Олександрович** — HTML-шаблони, стилізація інтерфейсу, UI адмін-панелі

## Завдання

### Обрана предметна область

Вебзастосунок **Internet Cafe & Drinks System** — система керування інтернет-кафе з функціями замовлення напоїв, адміністрування позицій меню, обліку відвідувань.

Зберігаються дані:
- користувачі
- бронювання
- історія відвідувань
- меню та асортимент напоїв
- замовлення користувачів

### Реалізовані вимоги

- [x] Рівень 1: База даних, CRUD, відгуки, структура проєкту
- [x] Рівень 2: додаткові таблиці, пов’язані з предметною областю
- [ ] Рівень 3: UI розширення, ускладнені функції статистики
...
#### Роль у команді — **Томашевський В.Д.**

- проєктування структури БД
- створення ORM моделей (User, Menu, Orders)
- визначення зв’язків один-до-багатьох
- модулі ініціалізації SQLAlchemy
- міграції структури
...
- валідація збереження позицій меню
- транзакції створення замовлень

## Висновки

Отримано навички структурного проєктування БД та опису сутностей через ORM. Побудовано стабільну модель даних для вебзастосунку. Робота з командою дозволила узгодити API, маршрути та моделі.

**Очікувана оцінка:** 7-8/12 балів
